...
const { handleSignUp, handleLogin, handleUpdateUser, handleGetUserById, handleGetUserByType, handleVerifyOtp, handleSendOtpForResetPassword, handleVerifyOtpForResetPassword, handleResetPassword, handleDeleteUser, handleCustomerLogin } = require("../controllers/user")
